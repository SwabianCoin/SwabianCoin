...
RUN wget https://github.com/SwabianCoin/SwabianCoin/releases/download/v20.02.02/swabiancoin_20.02.2-1_amd64.deb
RUN apt-get update && apt-get install -y ./swabiancoin_20.02.2-1_amd64.deb
